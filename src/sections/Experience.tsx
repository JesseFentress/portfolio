...
const employmentHistory: any  = [
    {
        ...
        tags: ["JavaScript", "React", "jQuery", "Django", "Python", "Elasticsearch", "PostgreSQL", "AWS"]
    },
    {
        startDate: "Aug 2022",
        endDate: "Feb 2023",
...
export const Experience: React.FC<any> = () => {
    ...
    return (
        <Section id="experience">
            ...
            <Link href="#" color="gray"  underline="none" className="block mt-8 md:mt-16 p-4 w">
                View Full Resume<span className="inline-block slide-up"><ArrowTopRightIcon /></span>
            </Link>
        </Section>
    );
}